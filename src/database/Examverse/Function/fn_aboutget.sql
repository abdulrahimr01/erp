...
CREATE OR REPLACE FUNCTION public.fn_aboutget(
    ...
    RETURNS TABLE(id bigint, type character varying, content character varying, isactive boolean, actionby character varying, actiondate timestamp without time zone) 
    LANGUAGE 'plpgsql'
    COST 100
