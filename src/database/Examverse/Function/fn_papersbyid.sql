-- FUNCTION: public.fn_papersbyid(character varying, bigint)

-- DROP FUNCTION IF EXISTS public.fn_papersbyid(character varying, bigint);
...
ALTER FUNCTION public.fn_papersbyid(character varying, bigint)
    OWNER TO postgres;
