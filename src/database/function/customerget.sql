-- FUNCTION: public.fn_customerget(character varying, integer, integer, character varying, character varying)

-- DROP FUNCTION IF EXISTS public.fn_customerget(character varying, integer, integer, character varying, character varying);
...
ALTER FUNCTION public.fn_customerget(character varying, integer, integer, character varying, character varying)
    OWNER TO postgres;
