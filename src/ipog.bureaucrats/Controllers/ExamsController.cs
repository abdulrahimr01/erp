...
namespace ipog.bureaucrats.Controllers
{
    ...
    public class ExamsController : ControllerBase
    {
        ...
        {
            string message = await _iExamsService.Update(examsModel);
            return Ok(message);
        }
        ...
        {
            string message = await _iExamsService.Delete(id);
            return Ok(message);
        }
        ...
        {
            string message = await _iExamsService.SetActiveStatus(id);
            return Ok(message);
        }
        ...
        {
            string message = await _iExamsService.SetInActiveStatus(id);
            return Ok(message);
        }
    }
}
