...
namespace ipog.erp.DataSource.IRepository
{
    public class RoleRepository : IRoleRepository
    {
        ...
        public async Task<List<Dictionary<string, object>>> GetById(long id)
        {
            try
            {
                ...
                List<Dictionary<string, object>> result = await _inpgsqlQuery.ExecuteReaderAsync(
                    "SELECT * FROM fn_rolesget(@p_action, @p_id)",
                    parameters
                );
                return result;
            }
        ...
        public async Task<List<Dictionary<string, object>>> GetAll()
        {
            ...
            List<Dictionary<string, object>> result = await _inpgsqlQuery.ExecuteReaderAsync(
                "SELECT * FROM fn_rolesget(@p_action)",
                parameters
            );
            return result;
        }
        ...
        public async Task<List<Dictionary<string, object>>> GetFilter(Pagination pagination)
        {
            ...
            List<Dictionary<string, object>> result = await _inpgsqlQuery.ExecuteReaderAsync(
                "SELECT * FROM fn_rolesget(@p_action, @p_id, @p_skip, @p_take, @p_ordercol, @p_orderdir)",
                parameters
            );
            return result;
        }
        ...
        public async Task<bool> Insert(Role role)
        {
            try
            {
                ...
                await _inpgsqlQuery.ExecuteQueryAsync(
                    "CALL sp_roles(@p_name, @p_notes, @p_isactive)",
                    parameters
                );
                return true;
            }
        ...
        public async Task<bool> Update(Role role)
        {
            try
            {
                ...
                await _inpgsqlQuery.ExecuteQueryAsync(
                    "CALL sp_roles(@p_name, @p_notes, @p_isactive, @p_id)",
                    parameters
                );
                return true;
            }
        ...
        public async Task<bool> Delete(long id)
        {
            try
            {
                ...
                bool success = await _inpgsqlQuery.ExecuteScalarAsync(
                    "SELECT fn_rolesbyid(@p_action, @p_id)",
                    parameters
                );
                return success;
            }
